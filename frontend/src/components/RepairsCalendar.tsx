...
// export function RepairsCalendar({ repairs, mechanics, defaultMechanicId }: RepairsCalendarProps) {
//     const [selectedMechanic, setSelectedMechanic] = useState<string>(defaultMechanicId?.toString() ?? "all");
...
//     // Grupowanie po dniu (z ISO wystarczy slice(0,10))
...
//                 <h2 className="text-xl font-semibold">Kalendarz napraw</h2>
...
//                                     </p>
//                                     <p className="text-xs text-gray-600">{r.time.slice(0, -3)}</p>
//                                 </div>
//                             ))}
//                         </div>
//                     </Card>
